  ...
  return (
    <div className="rounded-xl h-fit bg-white dark:bg-gray-950">
      <div className="grid grid-cols-3">
        <div className="flex col-span-2  flex-col gap-2 p-2 sm:p-5 items-left justify-center">
          <p>
        ...
        <div className=" flex items-center flex-col  justify-center">
          <div className="h-30 w-30 sm:w-45 sm:h-45 md:h-50 md:w-50">
            {icon}
          </div>
          <div className="flex  flex-col p-5 ">
            ...
            <p className="text-sm font-medium">
              <span className="text-xs sm:text-sm">Feels</span>
